...
const Footer = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-left text-sm text-darkgray font-sf-pro-text ${className}`}
    >
      <div className="w-[1224px] shadow-[0px_0px_2px_rgba(0,_0,_0,_0.08),_0px_2px_24px_rgba(0,_0,_0,_0.08)] rounded-xl bg-gray-300 flex flex-col items-center justify-start p-6 box-border gap-[40px] max-w-full mq750:gap-[20px]">
        <img
